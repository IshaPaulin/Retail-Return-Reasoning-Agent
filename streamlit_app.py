...
with st.form("chat_form", clear_on_submit=True):
    chat_text = st.text_area("Ask your returns assistant", key="chat_input", height=120)
    ...
    if submitted:
        ...
        if chat_text:
            ...
            if response_error:
                ...
                st.session_state.chat_conversation_id = response_data.get("conversation_id", st.session_state.chat_conversation_id)
